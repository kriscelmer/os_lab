...
Edit `nameservers` for `ens33` interface to make it look like this (mind the indentation):
...
Test **Designate** configuration by using FQDN inside of the Instance, run this command on the Instance prompt:
